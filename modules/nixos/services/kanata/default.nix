  ...
  ]
  {
    services.kanata = {
      ...
      keyboards.kbd = {
        port = 4743;
        devices = [
          "/dev/input/by-id/usb-ROYUAN_GamaKay_LK67_Keyboard-event-kbd"
          "/dev/input/by-id/usb-Logitech_USB_Receiver-event-mouse"
          "/dev/input/by-id/usb-Logitech_PRO_X_Wireless_6635B66E-event-mouse"
          "/dev/input/by-id/dev/input/by-id/usb-Logitech_PRO_X_Wireless_6635B66E-event-mouse'"
        ];
        config = ''
          (defsrc
            mfwd mbck
